...
import { setSearchTerm } from "../../cartSlice"; // Corrected import for setSearchTerm

const AmazonHeader = () => {
  let Navigate = useNavigate();
  let dispatch = useDispatch(); 
  let total = useSelector((state) => state.cart.addCart);
  let Profile_details = useSelector((state)=>state.cart.createacc);
  ...
  return (
    <header className="bg-gray-900 text-white py-2">
      <div className="max-w-full mx-auto flex flex-wrap items-center justify-between px-4">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden sm:block">
            {Profile_details.map((ele, ind) => (
              <div key={ind}>
                <p className="text-xs">Deliver to {ele.yourName}</p>
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="hidden md:flex flex-col items-end">
            {Profile_details.map((ele, ind) => (
              <div key={ele.id}>
                <p className="text-xs">Hello, {ele.yourName}</p>
          ...
          {/* Returns & Orders */}
          <div className="hidden md:flex flex-col items-end">
            <button onClick={()=>onclickreturnhandler()}>
      ...
      <nav className="bg-gray-800 py-2">
        <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-center space-x-4 md:space-x-6 text-xs md:text-sm">
          <a href="#" className="baner_bottom_navigation" onClick={() => onclickhomehandler()}>
            All
          </a>
          <a href="#" className="baner_bottom_navigation">Best Sellers</a>
          <a href="#" className="baner_bottom_navigation">New Releases</a>
          <a href="#" className="baner_bottom_navigation">Amazon miniTV</a>
          <a href="#" className="baner_bottom_navigation">Sell</a>
          <a href="#" className="baner_bottom_navigation">Books</a>
          <a href="#" className="baner_bottom_navigation">Buy Again</a>
          <a href="#" className="baner_bottom_navigation">AmazonBasics</a>
          <a href="#" className="baner_bottom_navigation">Gift Ideas</a>
          <a href="#" className="baner_bottom_navigation">Health, Household & Personal Care</a>
          <a href="#" className="baner_bottom_navigation">Home Improvement</a>
          <a href="#" className="baner_bottom_navigation">Gift Cards</a>
          <a href="#" className="baner_bottom_navigation">Home & Kitchen</a>
